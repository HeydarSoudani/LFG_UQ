...
def subsample_corpus():
    num_rows = 100
    input_file = "data/corpus/wiki-18.jsonl"
    output_file = f"data/corpus/wiki-18_{num_rows}.jsonl"
...
def main():
    ...
    parser.add_argument('--save_dir', default= 'data/corpus',type=str)
...
# python modules/retrieval/index_builder.py